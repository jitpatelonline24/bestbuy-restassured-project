...
public class ProductsAssertionTest {
    ...
    public void test004() {
        ...
        response.body("data.name",hasItems("Duracell - AAA Batteries (4-Pack)", "Duracell - AA 1.5V CopperTop Batteries (4-Pack)","Duracell - AA Batteries (8-Pack)"));
